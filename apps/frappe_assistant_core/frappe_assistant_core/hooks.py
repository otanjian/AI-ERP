...
extend_bootinfo = ["frappe_assistant_core.boot_extension.extend_desk_boot_ai_assistant"]

update_website_context = ["frappe_assistant_core.boot_extension.extend_website_boot_ai_assistant"]
