  ...
  const config = {
    plugins: [
      ...
      VitePWA({
        ...
        // CRM is embedded under Frappe (/crm + /assets/crm/frontend/). A default PWA
        // precaches the Vite index as "index.html" and Workbox then throws
        // "non-precached-url" for navigations — breaking the app and showing "Connecting...".
        disable: !isDev,
        devOptions: {
          enabled: isDev,
        },
